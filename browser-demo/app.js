...
elements.proactiveDemo.addEventListener('click', () => addMessage('fox','This is an accelerated demo of proactive help. The desktop application keeps its normal conservative thresholds; this button does not change them.',{proactive:true}))
